...
api.listaSemana = function (req, res) {
    let negociacoesAtuais = negociacoes.filter(function (negociacao) {
...
api.listaAnterior = function (req, res) {
    let negociacoesAnteriores = negociacoes.filter(function (negociacao) {
...
api.listaRetrasada = function (req, res) {
    let negociacoesRtrasadas = negociacoes.filter(function (negociacao) {
        return negociacao.data < dataAnterior;
    });
